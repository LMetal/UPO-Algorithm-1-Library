...
{
    entry_t * aa = (entry_t*)a;
    entry_t * bb = (entry_t*)b;
...
{
    printf("\n\n\n%d\n\n", order_by);
    upo_sort_comparator_t cmps[] = {by_artist_comparator, by_album_comparator, by_year_comparator, by_track_number_comparator, by_track_title_comparator};

    upo_merge_sort(playlist->entries, playlist->size, sizeof(entry_t), cmps[order_by-1]);
}
